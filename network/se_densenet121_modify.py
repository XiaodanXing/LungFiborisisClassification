...
class SeDenseNet1(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        densenet121 = torch.load(
            "/home/qiuping/data/newdata/results/data0613_SE_densenet121_0613_384*512_gray/checkpoints/ckpt_000120.pth")
        self.model_p = densenet121['model_state_dict']
        # First convolution
        ...
        param_dict = self.model_p
        # print self.model_p.keys()
        # nn.init.kaiming_normal_(se_dict['features.conv0.weight'])
        se_dict['features.conv0.weight'] = param_dict['module.model_p.features.conv0.weight']
        se_dict['features.norm0.weight'] = param_dict['module.model_p.features.norm0.weight']
        se_dict['features.norm0.bias'] = param_dict['module.model_p.features.norm0.bias']
        for i, num_layer in enumerate(block_config):
            for k in range(num_layer):
                se_dict['features.se_denseblock{}.se_denselayer{}.norm1.weight'.format(i + 1, k + 1)] = \
                    param_dict[
                        'module.model_p.features.denseblock{}.denselayer{}.norm1.weight'.format(i + 1, k + 1)]

                se_dict['features.se_denseblock{}.se_denselayer{}.norm1.bias'.format(i + 1, k + 1)] = \
                    param_dict[
                        'module.model_p.features.denseblock{}.denselayer{}.norm1.bias'.format(i + 1, k + 1)]

                se_dict['features.se_denseblock{}.se_denselayer{}.conv1.weight'.format(i + 1, k + 1)] = \
                    param_dict[
                        'module.model_p.features.denseblock{}.denselayer{}.conv1.weight'.format(i + 1, k + 1)]

                se_dict['features.se_denseblock{}.se_denselayer{}.norm2.weight'.format(i + 1, k + 1)] = \
                    param_dict[
                        'module.model_p.features.denseblock{}.denselayer{}.norm2.weight'.format(i + 1, k + 1)]

                se_dict['features.se_denseblock{}.se_denselayer{}.norm2.bias'.format(i + 1, k + 1)] = \
                    param_dict[
                        'module.model_p.features.denseblock{}.denselayer{}.norm2.bias'.format(i + 1, k + 1)]

                se_dict['features.se_denseblock{}.se_denselayer{}.conv2.weight'.format(i + 1, k + 1)] = \
                    param_dict[
                        'module.model_p.features.denseblock{}.denselayer{}.conv2.weight'.format(i + 1, k + 1)]

                nn.init.kaiming_normal_(
                    se_dict['features.se_denseblock{}.se_denselayer{}.conv_down.weight'.format(i + 1, k + 1)])

                # se_dict['features.se_denseblock{}.se_denselayer{}.conv_down.weight'.format(i + 1, k + 1)] = param_dict[
                #     'module.Firstnet.model_p.features.se_denseblock{}.se_denselayer{}.conv_down.weight'.format(i + 1,
                #                                                                                             k + 1)]
                # se_dict['features.se_denseblock{}.se_denselayer{}.conv_up.weight'.format(i + 1, k + 1)] = param_dict[
                #     'module.Firstnet.model_p.features.se_denseblock{}.se_denselayer{}.conv_up.weight'.format(i + 1,
                #                                                                                             k + 1)]
            ...
            if i != len(block_config) - 1:
                se_dict['features.transition{}.norm.weight'.format(i + 1)] = param_dict[
                    'module.features.transition{}.norm.weight'.format(i + 1)]

                se_dict['features.transition{}.norm.bias'.format(i + 1)] = param_dict[
                    'module.features.transition{}.norm.bias'.format(i + 1)]

                se_dict['features.transition{}.conv.weight'.format(i + 1)] = param_dict[
                    'module.features.transition{}.conv.weight'.format(i + 1)]

                se_dict['features.transition{}.conv_down.weight'.format(i + 1)] = param_dict[
                    'module.features.transition{}.conv_down.weight'.format(i + 1)]

                se_dict['features.transition{}.conv_up.weight'.format(i + 1)] = param_dict[
                    'module.features.transition{}.conv_up.weight'.format(i + 1)]
        ...
        se_dict['features.norm5.weight'] = param_dict['module.features.norm5.weight']
        se_dict['features.norm5.bias'] = param_dict['module.features.norm5.bias']
        se_dict['final_SE.conv_down.weight'] = param_dict['module.final_SE.conv_down.weight']
        se_dict['final_SE.conv_up.weight'] = param_dict['module.final_SE.conv_up.weight']
...
class End2EndSeDenseNet(nn.Module):
    ...
    def forward(self, x, flag):
        ...
        input = self.Img_synthesis(x, label, feature, weights)
